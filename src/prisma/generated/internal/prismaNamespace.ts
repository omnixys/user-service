...
> = {
  ...
  meta: {
    modelProps: 'user' | 'phoneNumber' | 'security' | 'passwordReset';
    ...
    Security: {
      ...
      operations: {
        ...
        count: {
          ...
          result:
            | runtime.Types.Utils.Optional<Prisma.SecurityCountAggregateOutputType>
            | number;
        };
      };
    };
...
export type SecurityScalarFieldEnum =
  (typeof SecurityScalarFieldEnum)[keyof typeof SecurityScalarFieldEnum];
